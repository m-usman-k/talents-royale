// Create floating particles for Signup page
document.addEventListener('DOMContentLoaded', function() {
    // Create particles container
    const particlesContainer = document.createElement('div');
    particlesContainer.className = 'signup-particles';
    document.querySelector('.signup-hero').appendChild(particlesContainer);
    ...
    const signupHero = document.querySelector('.signup-hero');
    if (signupHero) {
        document.addEventListener('mousemove', function(e) {
            ...
            signupHero.style.backgroundPosition = 
    ...
    const title = document.querySelector('.signup-content h1');
    if (title) {
    ...
    style.textContent = `
        ...
        .signup-particle {
            position: absolute;
            animation: floatSignup linear infinite;
            pointer-events: none;
